...
const stripeRoutes_1 = __importStar(require("./stripeRoutes"));
...
app.post("/api/stripe/webhook", express_1.default.raw({ type: "application/json" }), stripeRoutes_1.stripeWebhookHandler);
