...
export type FilterState = {
  ...
  suburb: string | null; // New: suburb name for filtering "Suburb (Postcode)" format
};
    ...
    <aside className="bg-white rounded-2xl shadow-lg p-5 space-y-6 border border-gray-100">
      ...
      <div>
        ...
        <SuburbSearchInput
          ...
          onChange={(suburb) => onChange({ suburb, postcode: "" })}
          placeholder="Type suburb or postcode (e.g., South Brisbane or 4101)..."
        />
        <p className="text-xs text-gray-500 mt-1">
          Find cleaners who service this area
        </p>
      </div>
